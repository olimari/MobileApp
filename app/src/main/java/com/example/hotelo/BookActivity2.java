...
public class BookActivity2 extends AppCompatActivity {
    ...
    String reservationID = "reservationID2";
    String id;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eReservate = findViewById(R.id.buttonResDone2);
        eRooms = findViewById(R.id.editRooms2);
        eAdults = findViewById(R.id.editAdults2);
        eKids = findViewById(R.id.editKids2);
        eEnd = findViewById(R.id.editResEnd2);
        eBeg = findViewById(R.id.editResBeg2);
        ...
        eReservate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(numberOfAdults.isEmpty() || numberOfKids.isEmpty() || numberOfRooms.isEmpty() || begin.isEmpty() || end.isEmpty()) {
                    ...
                    Toast.makeText(BookActivity2.this, "Proszę uzupełnić luki.", Toast.LENGTH_LONG).show();
                    return;
                }
                if (begin.length()!=8 || end.length()!=8){
                    Toast.makeText(BookActivity2.this, "Proszę poprawnie wprowadzić daty.", Toast.LENGTH_LONG).show();
                    return;
                }
                if (begin.equals(end)){
                    Toast.makeText(BookActivity2.this, "Proszę poprawnie wprowadzić daty.", Toast.LENGTH_LONG).show();
               ...
               /* if (begin.charAt(0) != '2' || end.charAt(0) != '2' || begin.charAt(1) != '0' || end.charAt(0) != '0' || begin.charAt(2) != '2' || end.charAt(2) != '2'){
                    Toast.makeText(BookActivity2.this, "Proszę poprawnie wprowadzić daty.", Toast.LENGTH_LONG).show();
                    return;
                }*/
                ...
                documentReference.set(data1).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        startActivity(new Intent(BookActivity2.this, ReservationActivity.class));
                    }
