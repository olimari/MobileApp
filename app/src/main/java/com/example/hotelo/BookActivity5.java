...
public class BookActivity5 extends AppCompatActivity {
    ...
    String reservationID = "reservationID5";
    String id;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eReservate = findViewById(R.id.buttonResDone5);
        eRooms = findViewById(R.id.editRooms5);
        eAdults = findViewById(R.id.editAdults5);
        eKids = findViewById(R.id.editKids5);
        eEnd = findViewById(R.id.editResEnd5);
        eBeg = findViewById(R.id.editResBeg5);
        ...
        eReservate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(numberOfAdults.isEmpty() || numberOfKids.isEmpty() || numberOfRooms.isEmpty() || begin.isEmpty() || end.isEmpty()) {
                    ...
                    Toast.makeText(BookActivity5.this, "Proszę uzupełnić luki.", Toast.LENGTH_LONG).show();
                    return;
                }
                if (begin.length()!=8 || end.length()!=8){
                    Toast.makeText(BookActivity5.this, "Proszę poprawnie wprowadzić daty.", Toast.LENGTH_LONG).show();
                    return;
                }
                if (begin.equals(end)){
                    Toast.makeText(BookActivity5.this, "Proszę poprawnie wprowadzić daty.", Toast.LENGTH_LONG).show();
                ...
                data1.put("nazwa", "Mercure");
                data1.put("miejscowość", "Gdynia");
                data1.put("adres", "Armii Krajowej 22, 81-372 Gdynia");
                data1.put("od", begin);
                data1.put("do", end);
                ...
                documentReference.set(data1).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        startActivity(new Intent(BookActivity5.this, ReservationActivity.class));
                    }
                ...
                //Toast.makeText(BookActivity5.this, "Zarezerwowano", Toast.LENGTH_LONG).show();
                //startActivity(new Intent(BookActivity5.this, ReservationActivity.class));
