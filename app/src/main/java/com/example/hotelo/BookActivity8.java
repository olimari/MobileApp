        ...
        eReservate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(numberOfAdults.isEmpty() || numberOfKids.isEmpty() || numberOfRooms.isEmpty() || begin.isEmpty() || end.isEmpty()) {
                    ...
                    Toast.makeText(BookActivity8.this, "Proszę uzupełnić luki.", Toast.LENGTH_LONG).show();
                    return;
                }
                if (begin.length()!=8 || end.length()!=8){
                    Toast.makeText(BookActivity8.this, "Proszę poprawnie wprowadzić daty.", Toast.LENGTH_LONG).show();
                    return;
                }
                if (begin.equals(end)){
                    Toast.makeText(BookActivity8.this, "Proszę poprawnie wprowadzić daty.", Toast.LENGTH_LONG).show();
                ...
                data1.put("miejscowość", "Sopot");
                data1.put("adres", "Powstańców Warszawy St 12/14, 81-718 Sopot");
                data1.put("od", begin);
                data1.put("do", end);
