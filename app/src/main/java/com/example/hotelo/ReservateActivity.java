        ...
        eReservate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(numberOfAdults.isEmpty() || numberOfKids.isEmpty() || numberOfRooms.isEmpty() || begin.isEmpty() || end.isEmpty()) {
                    ...
                    Toast.makeText(ReservateActivity.this, "Proszę uzupełnić luki.", Toast.LENGTH_LONG).show();
                    return;
                }
                if (begin.length()!=8 || end.length()!=8){
                    Toast.makeText(ReservateActivity.this, "Proszę poprawnie wprowadzić daty.", Toast.LENGTH_LONG).show();
                    return;
                }
                if (begin.equals(end)){
                    Toast.makeText(ReservateActivity.this, "Proszę poprawnie wprowadzić daty.", Toast.LENGTH_LONG).show();
                ...
                data1.put("adres", "Marszałkowska 93/94, Śródmieście, 00-510 Warszawa");
                data1.put("od", begin);
                data1.put("do", end);
